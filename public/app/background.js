...
const CONTEXT_MENU_ID = 'ehr-contextMenu';
const CONTEXT_MENU_TITLE = 'EHR | DeepScribe';
let chromeWindows = chrome.windows;

// const CONTEXT_MENU_URL = 'https://hhc.deepscribe.ai';
...
const ensureSendMessage = (tabId, message, callback) => {
  chrome.tabs.sendMessage(tabId, { ping: true }, (response) => {
    ...
    if (response && response.pong) { // Content script ready
      ...
      // chrome.tabs.executeScript(tabId, { file: "markr.js" }, () => {
